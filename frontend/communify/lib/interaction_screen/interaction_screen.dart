...
class InteractionScreen extends StatefulWidget {
 const InteractionScreen({Key key, this.animationController}) : super(key: key);
...
class _InteractionScreenState extends State<InteractionScreen> with TickerProviderStateMixin {
